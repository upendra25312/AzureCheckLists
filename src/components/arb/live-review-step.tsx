...
export function ArbLiveReviewStep(props: {
    ...
    return (
      <div className="arb-page-stack">
        {findings.some((f) => f.findingId.startsWith("fallback-")) ? (
          <section className="surface-panel" style={{ background: "var(--med-dim)", border: "1px solid var(--med)", borderRadius: "var(--radius-lg)", padding: "16px 20px", marginBottom: 0 }}>
            <p style={{ margin: 0, fontWeight: 600, color: "var(--med)" }}>
              ⚠ Provisional assessment — AI model was unavailable
            </p>
            <p className="section-copy" style={{ margin: "6px 0 0" }}>
              These findings were generated by a deterministic fallback because the AI agent timed out or was unreachable.
              Re-run the assessment from the Upload step to get full AI-grounded findings.
            </p>
          </section>
        ) : null}
  ...
  function renderScorecardContent() {
    ...
    return (
      <div className="arb-page-stack">
        {scorecard.confidence === "Low" && findings.some((f) => f.findingId.startsWith("fallback-")) ? (
          <section className="surface-panel" style={{ background: "var(--med-dim)", border: "1px solid var(--med)", borderRadius: "var(--radius-lg)", padding: "16px 20px", marginBottom: 0 }}>
            <p style={{ margin: 0, fontWeight: 600, color: "var(--med)" }}>
              ⚠ Provisional scorecard — AI model was unavailable
            </p>
            <p className="section-copy" style={{ margin: "6px 0 0" }}>
              This score was generated by a deterministic fallback. Re-run the assessment to get an AI-grounded scorecard.
            </p>
          </section>
        ) : null}
